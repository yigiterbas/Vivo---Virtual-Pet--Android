...
public class ArcTranslationAnimation extends Animation {
     ...
     */
    public ArcTranslationAnimation(float fromXDelta, float toXDelta,
     ...
     *            ABSOLUTE, or a percentage (where 1.0 is 100%) otherwise.
     */
    public ArcTranslationAnimation(int fromXType, float fromXValue, int toXType,
