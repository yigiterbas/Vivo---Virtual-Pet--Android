...
public class CollageViewHalfEllipse extends ImageView {
    ...
    public CollageViewHalfEllipse(Context context) {
        this(context, null);
    }

    public CollageViewHalfEllipse(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        setPadding(PADDING, PADDING, PADDING, PADDING);
    }

    public CollageViewHalfEllipse(Context context, AttributeSet attrs, int defStyle) {
